...
describe('Auth', () => {
  ...
  describe('Not Authenticated', () => {
    ...
    it('should display app title and description', () => {
      ...
      expect(screen.getByText(/Log ind for at synkronisere/)).toBeInTheDocument()
    })
    ...
    it('should display features list', () => {
      ...
      expect(screen.getByText(/Dine data er kun synlige for dig/)).toBeInTheDocument()
  ...
  describe('Authenticated', () => {
    ...
    it('should not display login UI when authenticated', () => {
      ...
      expect(screen.queryByText('Log ind med Google')).not.toBeInTheDocument()
      expect(screen.queryByText(/Automatisk synkronisering/)).not.toBeInTheDocument()
    })
  })
