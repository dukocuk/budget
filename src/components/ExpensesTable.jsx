      ...
      <tr>
        ...
        <td>
          <select
            ...
            onChange={e =>
              onUpdate(expense.id, { startMonth: parseInt(e.target.value) })
            }
        ...
        <td>
          <select
            ...
            onChange={e =>
              onUpdate(expense.id, { endMonth: parseInt(e.target.value) })
            }
        ...
        <td>
          <div className="row-actions">
            <button
              ...
              title={
                readOnly
                  ? 'Kan ikke kopiere fra arkiveret år'
                  : 'Kopier denne udgift'
              }
              disabled={readOnly}
            >
...
export const ExpensesTable = ({
  ...
  useEffect(() => {
    const handleClickOutside = event => {
      if (
        showInlineAdd &&
        inlineRowRef.current &&
        !inlineRowRef.current.contains(event.target)
      ) {
