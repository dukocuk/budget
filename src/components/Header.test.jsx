...
describe('Header', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render subtitle', () => {
      ...
      expect(screen.getByText('Administrer dine faste udgifter i DKK')).toBeInTheDocument()
    })
    ...
    it('should not render user section when no user', () => {
      ...
      expect(screen.queryByRole('button', { name: /indstillinger/i })).not.toBeInTheDocument()
    })
  })
  ...
  describe('User Profile', () => {
    ...
    it('should display user email as name when full_name not available', () => {
      ...
      render(<Header user={userWithoutName} onOpenSettings={mockOnOpenSettings} />)
    ...
    it('should display fallback avatar when no avatar_url', () => {
      ...
      render(<Header user={userWithoutAvatar} onOpenSettings={mockOnOpenSettings} />)
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle undefined user_metadata', () => {
      ...
      render(<Header user={userWithoutMetadata} onOpenSettings={mockOnOpenSettings} />)
    ...
    it('should capitalize fallback avatar letter', () => {
      ...
      render(<Header user={userLowerCase} onOpenSettings={mockOnOpenSettings} />)
