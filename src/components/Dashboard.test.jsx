...
describe('Dashboard', () => {
  ...
  describe('Charts', () => {
    ...
    it('should render bar chart for monthly expenses vs income', () => {
      ...
      expect(screen.getByText('Månedlige udgifter vs. indbetaling')).toBeInTheDocument()
    ...
    it('should render line chart for balance projection', () => {
      ...
      expect(screen.getByText('Balance prognose over året')).toBeInTheDocument()
    ...
    it('should not render pie chart when no expenses exist', () => {
      ...
      expect(screen.queryByText('Udgifter efter frekvens')).not.toBeInTheDocument()
    })
  })
