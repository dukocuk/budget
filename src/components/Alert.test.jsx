...
describe('Alert', () => {
  ...
  it('applies correct type class for info alert', () => {
    const { container } = render(<Alert message="Info message" type={ALERT_TYPES.INFO} />)
  ...
  it('applies correct type class for success alert', () => {
    const { container } = render(<Alert message="Success message" type={ALERT_TYPES.SUCCESS} />)
    const alert = container.querySelector('.alert')
  ...
  it('applies correct type class for error alert', () => {
    const { container } = render(<Alert message="Error message" type={ALERT_TYPES.ERROR} />)
    const alert = container.querySelector('.alert')
  ...
  it('returns null when message is null', () => {
    const { container } = render(<Alert message={null} type={ALERT_TYPES.INFO} />)
    expect(container.firstChild).toBeNull()
  })

  it('returns null when message is undefined', () => {
    const { container } = render(<Alert message={undefined} type={ALERT_TYPES.INFO} />)
    expect(container.firstChild).toBeNull()
  })

  it('renders long messages correctly', () => {
    const longMessage = 'Dette er en meget lang besked der skulle vises i alert komponenten for at teste om den kan håndtere lange beskeder korrekt.'
